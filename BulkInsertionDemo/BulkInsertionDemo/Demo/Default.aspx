...
<table style="color:White;margin-top:25px" >
   ...
   <div style="margin-top:20px;margin-left:10px;">
    ...
    <Columns>
    <asp:BoundField  HeaderStyle-Width="120px" HeaderText="Product_Name" DataField="Product_Name"/>
     <asp:BoundField HeaderStyle-Width="120px" HeaderText="Brand_Name" DataField="Brand_Name"/>
